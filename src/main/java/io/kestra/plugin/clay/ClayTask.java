    ...
    examples = {
        @io.kestra.core.models.annotations.Example(
            ...
            code = """
                ...
                tasks:
                  - id: reverse
                    type: io.kestra.plugin.clay.ClayTask
                    format: "Text to be reverted"
                """
        )
    }
)
public class ClayTask extends Task implements RunnableTask<ClayTask.Output> {
    @Schema(
    ...
    @Override
    public ClayTask.Output run(RunContext runContext) throws Exception {
